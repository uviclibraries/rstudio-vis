...
Before we start with how to clean, manipulate and visualize our data, we want to introduce you to the `|>` symbol, which is very powerful to use in conjunction with the tidyverse package to easily manipulate and visualize data.
