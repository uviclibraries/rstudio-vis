...
*Note:* In cases where there are more columns that fit horizontally in the console, the results will wrap, as seen in the output of Task 1-4.
...
In Tasks 1-7 and 1-8, we ran two commands, resulting in two separate objects containing the column names:
