...
As you can see, the `clean_names()` function fixed all the column names to a standardized format keeping all lower case and "_". If you want to know more about other helpful function from the `janitor` package, you can check [this link](https://sfirke.github.io/janitor/articles/janitor.html)

### 5.2 Correcting variable types

### 5.3 Validating your data

CONTENT TO BE ADDED USING assertr PACKAGES
