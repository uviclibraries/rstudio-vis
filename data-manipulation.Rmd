...
# Data Manipulation
    ...
    - [4.4 Select specific rows based on a condition](#44-select-specific-rows-based-on-a-condition)
    - [4.5 Modify a data frame with `mutate()`](#45-modify-a-data-frame-with-mutate)
    - [4.6 Sorting data with `arrange()`](#46-sorting-data-with-arrange)
    - [4.7 Summarizing variables with `summarise()`](#47-summarizing-variables-with-summarise)
    - [4.8 Analyzing groups with `group_by()`](#48-analyzing-groups-with-group_by)
